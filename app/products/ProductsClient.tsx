...
const CATEGORY_ORDER: { id: string; title: string; subs: string[] }[] = [
  {
    id: "living",
    title: "Living Room",
  ...
  return (
    <main className="bg-[#F7F2EA] text-stone-800">
      <div className="mx-auto max-w-6xl px-6 pt-32 sm:px-8 lg:px-10 lg:pt-40">
              ...
              <section key={cat.id} id={cat.id} className="scroll-mt-24">
                <FadeIn>
                  <div className="mb-12 text-center">
                    ...
                    <span className="mx-auto mt-4 block h-px w-10 bg-[#B39A80]" />
                  </div>
                </FadeIn>
        ...
        {/* CUSTOM */}
        <section id="custom" className="scroll-mt-24 pt-28">
          <FadeIn>
            <div className="rounded-sm border border-stone-200 bg-white/60 px-8 py-16 text-center sm:px-16">
              <p className="text-xs font-medium uppercase tracking-[0.4em] text-stone-400">
                Bespoke
              </p>
