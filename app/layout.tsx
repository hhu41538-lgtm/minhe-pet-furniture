...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="en" className={`${inter.variable} ${playfairDisplay.variable} ${jost.variable}`}>
      <body className="min-h-screen bg-[#F7F2EA] text-stone-800 antialiased">
        <script
        ...
        <a href="https://wa.me/8618320072414" target="_blank" rel="noreferrer" aria-label="Contact us on WhatsApp"
